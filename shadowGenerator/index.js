 ...
 * @see https://ethercreative.github.io/react-native-shadow-generator/
 * @param {number} elevation
 * @returns {{elevation: *, shadowRadius: string, shadowOffset: {width: number, height: number}, shadowOpacity: string, shadowColor: string}}
 */
export const shadowGenerator = elevation => {
    ...
    const radius = interpolate(s.blur, 1, 38, 1, 16).toFixed(2);//(s.blur * 0.45).toFixed(2);
    return {
        shadowColor: "#000",
        shadowOffset: {
            width: 0,
